...
const CardVirus = ({data, color}) => {
  ...
  return (
    <div className="card group overflow-hidden rounded bg-white w-[285px] font-bold text-[1.1250em] relative transition ease hover:-translate-y-3 duration-500 shadow-[0_15px_30px_0_rgba(20,50,90,0.05)]">
      <div className="title">
