const CardTop10Country = ({ flag, country, cases }) => {
  return (
    <div className="flex items-center justify-between mb shadow border-[1px] border-slate-100 hover:scale-105 transition duration-500 font-medium max-w-sm p-4 rounded-lg">
