...
const StaySection = () => {
  return (
    <section className=" border-non md:grid grid-cols-2 pt-32 pl-4 bg-dark-blue-2">
        ...
        <div>
          <img src="/public\assets\images\mobiles.png" alt="covid-girl-phone" className="overflow-clip align-middle border-none w-[25em] md:w-[32em] mb-24 mt-5 md:ml-28" />
        </div>
    </section>
  )
}
