...
const StaySection = () => {
  return (
    <section className=" flex flex-col border-non md:grid md:grid-cols-2 pt-14 md:pt-32 pl-4 bg-dark-blue-2">
        ...
        <div>
          <img src="/public\assets\images\mobiles.png" alt="covid-girl-phone" className="overflow-clip align-middle border-none w-[25em] md:w-[32em] mb-10 md:mb-24 mt-5 md:ml-28" />
        </div>
    </section>
  )
}
